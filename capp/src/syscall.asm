...
GLOBAL _input_char_inSM,_beep,_RAND,_GetCmdline,_Get_System_Version,_Copy,__kbhit
GLOBAL _mkdir,_mkfile,_Edit_File,_SwitchTo320X200X256_BIOS,_SwitchToText8025_BIOS
GLOBAL _AddTask,_SubTask,_SwitchToHighTextMode,_HighPrint,_ReTurnToNornalTextMode
[SECTION .text]
_putch:
push	edx
push	eax
...
_Edit_File:
    ...
    mov edx,[esp+4+20] ;文件名
    mov esi,[esp+8+20] ;编辑内容
    mov ecx,[esp+12+20] ;编辑内容长度
    int 36h
    pop ecx
    pop esi
    pop edx
