...
int decode0_JPEG(struct DLL_STRPICENV *env, int size, unsigned char *fp0, int b_type,
...
void MakePraFile(char* PraFileName, uint8_t* imgBuffer, uint32_t xsize, uint32_t ysize);
void PraShell();
