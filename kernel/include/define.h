...
/* dos.h */
#define VERSION "0.6b" // Version of the program
...
extern unsigned int ADR_DISKIMG;
extern struct MOUSE_DEC mdec;
extern int mx, my;
extern char *font, *ascfont, *hzkfont;
extern struct TIMERCTL timerctl;
extern char *line, *path;
...
/* fs.h */
#define Path_Addr fopen("A:\\PATH.SYS")
#define EOF -1
#define SEEK_SET 0
#define SEEK_CUR 1
#define SEEK_END 2
...
#define COL_91_140_240 0x005b8cf0
...
struct SocketServer {
  ...
  void (*Send)(struct SocketServer *server, uint8_t *data, uint32_t size); // TCP/UDP
};
