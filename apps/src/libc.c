...
//   Free((char*)p - sizeof(int), size + sizeof(int));
// }
// int flag_check(FILE* fp, int flag) {
//   if (fp == NULL) {
//     return -1;
//   }
//   if (fp->_flags & flag) {
...
//   }
//   if (fsz != 0) {
//     fp->buf_ptr = (char*)malloc(fsz);
//   } else {
//     fp->buf_ptr = NULL;
//   }
//   fp->index = 0;
//   fp->file_len = fsz;
//   fp->file_name = (char*)malloc(strlen(path) + 1);
//   strcpy(fp->file_name, path);
//   for (int i = 0; i < strlen(mode); i++) {
//     switch (mode[i]) {
//       case 'r':
//         fp->_flags = fp->_flags | FILE_FLAG_READ;
//         break;
//       case 'w':
//         fp->_flags = fp->_flags | FILE_FLAG_WRITE;
//         break;
//       case 'a':
//         fp->_flags = fp->_flags | FILE_FLAG_APPEND;
//         break;
//       case 'b':
//         fp->_flags = fp->_flags | FILE_FLAG_BINARY;
//         break;
//       case '+':
//         fp->_flags = fp->_flags | FILE_FLAG_READ | FILE_FLAG_WRITE;
//         break;
//       default:
//         return NULL;
//     }
//   }
//   if (flag_check(fp, FILE_FLAG_READ) == 0) {
//   }
// }
...
//     return -1;
//   }
//   if (flag_check(fp, FILE_FLAG_WRITE) == 0 ||
//       flag_check(fp, FILE_FLAG_APPEND) == 0) {
//     Edit_File(fp->file_name, fp->buf_ptr, fp->file_len);
//   }
//   free(fp->buf_ptr);
//   free(fp);
//   return 0;
...
//   }
//   int len = size * count;
//   if (fp->index + len > fp->file_len) {
//     len = fp->file_len - fp->index;
//   }
//   memcpy(ptr, fp->buf_ptr + fp->index, len);
//   fp->index += len;
//   return len;
// }
